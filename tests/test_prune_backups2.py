...
def test_prune_backups_keep(mock_build, mock_iter):
    ...
    with patch("codex_manager.restore.metadata_path_for_archive") as mock_meta:
        ...
        perform_prune_backups(Path("dir"), keep=1, dry_run=True)
